...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="floo">
    <form action="{{ route('admin.data_galery.update', $galery->id) }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="mb-3">
                <label for="judul">Judul</label>
                <input type="text" name="judul" id="judul" class="form-control" required value="{{ $galery->judul }}">
            </div>
